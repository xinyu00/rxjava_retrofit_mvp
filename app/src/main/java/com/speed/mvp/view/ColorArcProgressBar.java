...
public class ColorArcProgressBar extends View {
    ...
    private Paint allArcPaintBig;
    private Paint progressPaintBig;
    ...
    private float hintSize = dipToPx(14);
    private float curSpeedSize = dipToPx(13);
    private int aniSpeed = 4000;
    ...
    private String hintColor = "#AAAAAA";
    private String titleColor = "#1C86EE";
    ...
    private void initView() {
        ...
        //大弧形的矩阵区域
        bgRectBig = new RectF();
        bgRectBig.top = longdegree + progressWidth / 2 + DEGREE_PROGRESS_DISTANCE - dipToPx(15);
        bgRectBig.left = longdegree + progressWidth / 2 + DEGREE_PROGRESS_DISTANCE - dipToPx(15);
        bgRectBig.right = diameter + (longdegree + progressWidth / 2 + DEGREE_PROGRESS_DISTANCE) + dipToPx(15);
        bgRectBig.bottom = diameter + (longdegree + progressWidth / 2 + DEGREE_PROGRESS_DISTANCE) + dipToPx(15);
        ...
        //外弧度
        allArcPaintBig = new Paint();
        allArcPaintBig.setAntiAlias(true);
        allArcPaintBig.setStyle(Paint.Style.STROKE);
        allArcPaintBig.setStrokeWidth(dipToPx(2));
        allArcPaintBig.setColor(Color.parseColor(bgArcColor));
        allArcPaintBig.setStrokeCap(Paint.Cap.ROUND);
        ...
        //当前进度的外弧
        progressPaintBig = new Paint();
        progressPaintBig.setAntiAlias(true);
        progressPaintBig.setStyle(Paint.Style.STROKE);
        progressPaintBig.setStrokeCap(Paint.Cap.ROUND);
        progressPaintBig.setStrokeWidth(dipToPx(3));
        progressPaintBig.setColor(Color.GREEN);

        //内容显示文字
        vTextPaint = new Paint();
        vTextPaint.setTextSize(textSize);
        vTextPaint.setColor(Color.parseColor("#1C86EE"));
        ...
        curSpeedPaint.setColor(Color.parseColor(titleColor));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        progressPaintBig.setShader(sweepGradient);
